  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <AnimatePresence>
        {showTooltip && (
          ...
          >
            ...
            <div className="text-xs text-gray-300">Escríbenos por WhatsApp</div>
      ...
      <motion.button
        ...
        className="w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200"
      >
